...
use crate::async_runtime::tls::{load_certs as tls_load_certs, load_crls as tls_load_crls, load_private_key as tls_load_pkey};
...
pub(crate) struct WorkerConfig {
    pub id: i32,
    sock: Py<crate::async_runtime::tcp::SocketHolder>,
    pub threads: usize,
